...
const paths = {
  ...
  gauge: <><path d="M20.4 15a9 9 0 1 0-16.8 0"/><path d="M12 12 16.5 7.5"/><circle cx="12" cy="12" r="1"/><path d="M5 19h14"/></>,
  chip: <><rect x="7" y="7" width="10" height="10" rx="2"/><path d="M9 2v3M15 2v3M9 19v3M15 19v3M2 9h3M2 15h3M19 9h3M19 15h3"/></>,
  leaf: <><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 18 2 18 2c1 5.5-.1 10.4-4 13.2-2.2 1.6-4.6 1.7-6.3.8"/><path d="M2 21c0-3 1.9-5.5 5.7-7.5 2.7-1.4 5.8-2.3 9.3-2.7"/></>,
